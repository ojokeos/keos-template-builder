...
function At(s, r) {
  var o, m, v;
  const i = [], d = r ?? s.audience.estimated_reach;
...
function Be(s, r = "error") {
  return { message: s, severity: r };
}
function mt(s) {
  var i, d, o, m;
  const r = [];
  return s.schema_version || r.push(Be("Missing schema_version")), (i = s.message.title_template) != null && i.trim() || r.push(Be("Title is required")), (d = s.message.body_template) != null && d.trim() || r.push(Be("Message body is required")), s.audience.type === "topic" && !((o = s.audience.topic_name) != null && o.trim()) && r.push(Be("Topic name is required when targeting by topic")), s.audience.platforms.length === 0 && r.push(Be("At least one platform (iOS, Android, Web) must be selected")), s.tracking && !((m = s.tracking.campaign_name) != null && m.trim()) && r.push(Be("Campaign name is required for tracking")), s.delivery.ttl_seconds <= 0 && r.push(Be("TTL must be greater than 0")), {
    valid: r.length === 0,
    errors: r
  };
}
function Lt(s, r) {
  const i = mt(s), d = At(s, r);
  return {
    valid: i.valid,
    errors: [
      ...i.errors,
...
const He = We.android;
function Pt(s) {
  const { title: r, body: i } = s, d = Ee(r || "", He.title), o = Ee(i || "", He.body);
  return {
    title: d.text,
    body: o.text,
    imageUrl: s.imageUrl,
...
function Vt(s, r = {}) {
  const i = r.expanded ? Et(s) : Pt(s);
  return r.darkMode !== void 0 && (i.darkMode = r.darkMode), i;
}
const tt = We.ios;
function vt(s) {
  const { title: r, body: i } = s, d = Ee(r || "", tt.title), o = Ee(i || "", tt.body);
  return {
    title: d.text,
    body: o.text,
    imageUrl: s.imageUrl,
...
function Ot(s, r = {}) {
  const i = r.variant === "lockscreen" ? Mt(s) : vt(s);
  return r.darkMode !== void 0 && (i.darkMode = r.darkMode), i;
}
const st = We.web;
function at(s) {
  const { title: r, body: i } = s, d = Ee(r || "", st.title), o = Ee(i || "", st.body);
  return {
    title: d.text,
    body: o.text,
    imageUrl: s.imageUrl,
...
function Fe(s = {}) {
  ...
  ye(
    ...
    () => {
      var U;
      d.value = !0, (U = s.onDirty) == null || U.call(s);
    },
    { deep: !0 }
  );
  const N = I(() => mt(r.value));
  function w(U) {
    const se = Lt(r.value, U);
    return {
      ...se,
      blockingErrors: Tt(se),
      warnings: Bt(se),
      valid: se.valid
    };
  }
  ...
  function _e(U, se) {
    ...
    switch (U) {
      case "android":
        C = Vt(ne, { expanded: se == null ? void 0 : se.expanded });
        break;
      case "ios":
        C = Ot(ne);
        break;
...
function je(s, r) {
  const i = r.channel, d = I(
    () => {
      ...
      return zt(
        i,
        r.key ?? ((Y = s.value) == null ? void 0 : Y.id) ?? ((N = s.value) == null ? void 0 : N.name) ?? "draft"
      );
    }
  ), o = J(null);
  let m = null;
  ...
  return ye(
    s,
    () => {
      T() && (m && clearTimeout(m), m = setTimeout(() => {
        m = null, v();
      }, Dt));
    },
    { deep: !0 }
...
const Ht = { class: "kb-header__row" }, Wt = ["value"], Ft = { class: "kb-header__actions" }, jt = ["disabled"], qt = ["disabled"], Kt = ["value"], Yt = ["value"], Jt = /* @__PURE__ */ le({
  ...
  for (const [d, o] of r)
    i[d] = o;
  return i;
}, qe = /* @__PURE__ */ ie(Jt, [["__scopeId", "data-v-bf624780"]]), Gt = { class: "kb-section" }, Qt = { class: "kb-section__head" }, Xt = { class: "kb-section__desc" }, Zt = { class: "kb-field" }, es = { class: "kb-label" }, ts = { class: "kb-field-with-rail" }, ss = ["value", "aria-invalid", "aria-describedby"], as = {
  key: 0,
  id: "title-error",
  ...
  setup(s) {
    ...
    return (i, d) => (a(), n("section", Gt, [
      ...
      e("p", Xt, " Title and body are required. Character limits depend on the selected platform (" + h(s.selectedPlatform) + "). ", 1),
      e("div", Zt, [
        e("label", es, [
          d[7] || (d[7] = Q(" Title ", -1)),
          e("span", {
        ...
        e("div", ts, [
          e("input", {
            ...
            value: s.message.title_template,
        ...
        s.titleError ? (a(), n("p", as, h(s.titleError), 1)) : S("", !0)
      ]),
      e("div", ns, [
        e("label", ls, [
          d[9] || (d[9] = Q(" Message ", -1)),
        ...
        s.bodyError ? (a(), n("p", rs, h(s.bodyError), 1)) : S("", !0)
      ]),
      e("div", ds, [
        ...
        s.imageUrlError ? (a(), n("p", cs, h(s.imageUrlError), 1)) : S("", !0)
      ]),
      e("div", ps, [
        ...
        s.deepLinkError ? (a(), n("p", vs, h(s.deepLinkError), 1)) : S("", !0)
      ]),
      e("div", bs, [
        ...
        e("div", gs, [
          (a(!0), n(H, null, q(r.message.actions ?? [], (o, m) => (a(), n("div", {
            key: o.id || m,
            class: "kb-action-row"
          }, [
            e("input", {
              ...
              onInput: (v) => {
                ...
                p[y] = {
                  ...p[y],
                  id: ((T = p[y]) == null ? void 0 : T.id) || `action_${y + 1}`,
          ...
          e("div", _s, [
            ...
            (a(), n(H, null, q(["View order", "Track shipment", "Open app"], (o) => e("button", {
              key: o,
              type: "button",
...
}), xs = /* @__PURE__ */ ie($s, [["__scopeId", "data-v-59cdf63d"]]), Cs = { class: "kb-section kb-section--inline-personalization" }, Ss = { class: "kb-field" }, Is = { class: "kb-insert-row" }, Us = ["value"], Rs = { class: "kb-field" }, As = { class: "kb-insert-row" }, Ls = { class: "kb-field" }, Ts = { class: "kb-variable-list" }, Bs = /* @__PURE__ */ le({
  ...
  setup(s, { emit: r }) {
    const i = s, d = r, o = ["first_name", "last_name", "order_id", "city"], m = J(i.variableOptions ?? o), v = J(m.value[0] ?? o[0]), p = J("");
    ye(
      () => i.variableOptions,
      (N) => {
    ...
    return (N, w) => (a(), n("section", Cs, [
      ...
      e("div", Ss, [
        ...
        e("div", Is, [
          Ie(e("select", {
            "onUpdate:modelValue": w[0] || (w[0] = (M) => v.value = M),
            class: "kb-select"
          }, [
            (a(!0), n(H, null, q(y.value, (M) => (a(), n("option", {
              key: M,
              value: M
            }, h(M), 9, Us))), 128))
          ], 512), [
          ...
          e("button", {
            type: "button",
            class: "kb-btn-insert",
            onClick: w[1] || (w[1] = (M) => T("title"))
          }, "Into title"),
          e("button", {
            type: "button",
            class: "kb-btn-insert",
            onClick: w[2] || (w[2] = (M) => T("body"))
          }, "Into message")
        ])
      ]),
      e("div", Rs, [
        ...
        e("div", As, [
          Ie(e("input", {
            "onUpdate:modelValue": w[3] || (w[3] = (M) => p.value = M),
            type: "text",
            class: "kb-input",
      ...
      e("div", Ls, [
        ...
        e("ul", Ts, [
          (a(!0), n(H, null, q(y.value, (M) => (a(), n("li", { key: M }, [
            e("code", null, "{{ " + h(M) + " }}", 1)
          ]))), 128))
        ])
      ])
...
}), bt = /* @__PURE__ */ ie(Bs, [["__scopeId", "data-v-6d49f6dc"]]), Ps = { class: "kb-section kb-section--template-type" }, Es = { class: "kb-field" }, Vs = { class: "kb-radio-group" }, Ms = { class: "kb-radio" }, Os = ["checked"], Ns = { class: "kb-radio" }, Ds = ["checked"], zs = /* @__PURE__ */ le({
...
}), Ke = /* @__PURE__ */ ie(zs, [["__scopeId", "data-v-991f74e5"]]), Hs = { class: "kb-section" }, Ws = { class: "kb-section__head" }, Fs = { class: "kb-section__desc" }, js = { class: "kb-field" }, qs = { class: "kb-radio-group" }, Ks = { class: "kb-radio" }, Ys = ["checked"], Js = { class: "kb-radio" }, Gs = ["checked"], Qs = {
  key: 0,
        ...
        s.showPushOptions ? (a(), n(H, { key: 1 }, [
          e("div", ea, [
            ...
            e("select", {
              ...
              (a(!0), n(H, null, q(c(St), (m) => (a(), n("option", {
                key: m,
                value: m
              }, h(r[m] ?? m + "s"), 9, sa))), 128))
            ], 40, ta)
          ...
          e("div", aa, [
            ...
            e("select", {
              ...
              (a(!0), n(H, null, q(c(ut), (m) => (a(), n("option", {
                key: m,
                value: m
              }, h(m), 9, la))), 128))
            ], 40, na)
          ...
          e("div", oa, [
            e("label", ia, [
              e("input", {
                ...
                onChange: d[7] || (d[7] = (m) => i.$emit("update", { quiet_hours_respected: !s.delivery.quiet_hours_respected }))
              }, null, 40, ra),
        ...
        e("div", ba, [
          e("label", ga, [
            e("input", {
              ...
              onChange: i[1] || (i[1] = (d) => r.$emit("update", { silent_push: !s.delivery.silent_push }))
            }, null, 40, ya),
...
function Pe(s, r) {
  return !s || typeof s != "string" ? s : s.replace(/\{\{\s*([^}]+?)\s*\}\}/g, (i, d) => {
    const o = d.trim();
...
const Ve = [
...
}, La = { class: "kb-ios-banner" }, Ta = { class: "kb-ios-content" }, Ba = {
  key: 0,
  class: "kb-ios-title"
}, Pa = {
  key: 1,
    ...
    return (m, v) => (a(), n("div", ka, [
      ...
      s.selectedPlatform === "android" ? (a(), n("div", $a, [
        ...
        e("div", {
          ...
          e("div", xa, [
            o.value.title ? (a(), n("div", Ca, h(o.value.title), 1)) : S("", !0),
            o.value.body ? (a(), n("div", Sa, h(o.value.body), 1)) : S("", !0),
            ...
            o.value.actions && o.value.actions.length ? (a(), n("div", Ra, [
              (a(!0), n(H, null, q(o.value.actions, (p) => (a(), n("button", {
                key: p.id,
                type: "button",
        ...
        e("div", La, [
          ...
          e("div", Ta, [
            ...
            o.value.title ? (a(), n("div", Ba, h(o.value.title), 1)) : S("", !0),
            o.value.body ? (a(), n("div", Pa, h(o.value.body), 1)) : S("", !0),
            o.value.actions && o.value.actions.length ? (a(), n("div", Ea, [
              (a(!0), n(H, null, q(o.value.actions, (p) => (a(), n("button", {
                key: p.id,
                type: "button",
        ...
        e("div", Na, [
          ...
          e("div", Da, [
            o.value.title ? (a(), n("div", za, h(o.value.title), 1)) : S("", !0),
            o.value.body ? (a(), n("div", Ha, h(o.value.body), 1)) : S("", !0),
          ...
          o.value.actions && o.value.actions.length ? (a(), n("div", ja, [
            (a(!0), n(H, null, q(o.value.actions, (p, y) => (a(), n("button", {
              key: p.id || y,
              type: "button",
...
}), Ka = /* @__PURE__ */ ie(qa, [["__scopeId", "data-v-539e2af6"]]), Ya = { class: "kb-version-dialog" }, Ja = {
  key: 0,
    ...
    return (o, m) => s.open ? (a(), n("div", {
      ...
      e("div", Ya, [
        ...
        s.versions.length === 0 ? (a(), n("div", Ja, ' No versions saved yet. Use "Save as version" to create one. ')) : (a(), n("ul", Ga, [
          (a(!0), n(H, null, q(s.versions, (v) => (a(), n("li", {
            key: v.id,
            class: "kb-version-item"
          }, [
            e("span", Qa, h(v.label || d(v.timestamp)), 1),
            e("button", {
              type: "button",
  ...
  setup(s, { emit: r }) {
    const i = s, d = r, o = J("android"), m = J(""), v = J(!1), p = J(null), y = J(!1), T = I(() => R.value.workflow_status ?? "draft"), Y = I(() => {
      const _ = m.value;
      return _ ? Ve.find((g) => g.id === _) ?? null : null;
    });
    function N(_) {
      const g = R.value, x = _.campaign.message ? { ...g.message, ..._.campaign.message } : g.message, Z = _.campaign.delivery ? { ...g.delivery, ..._.campaign.delivery } : g.delivery;
      f({
        ..._.campaign,
        message: x,
        delivery: Z
    ...
    function w(_) {
      ...
      if (!g) return;
      const x = nt.find((Z) => Z.id === g);
      x && (W.value ? (p.value = x, v.value = !0) : N(x), _.target.value = "");
    }
    function M(_) {
      R.value = _, y.value = !1;
    }
    ...
    }), { lastSavedAt: C } = je(R, { channel: "push" });
    function fe(_) {
    ...
    const ge = I(() => A(we.value)), ue = I(() => ge.value.blockingErrors), Re = I(() => ge.value.warnings), B = I(() => ge.value.valid), O = I(() => se[o.value].title), K = I(() => se[o.value].body), ce = I(() => R.value.message.title_template.length), D = I(() => R.value.message.body_template.length), z = I(() => {
    ...
    function P(_) {
      const g = ` {{ ${_.variable} }}`, x = R.value.message.variables_used ?? [], Z = Array.from(/* @__PURE__ */ new Set([...x, _.variable]));
      _.field === "title" ? ee({
    ...
    return (_, g) => (a(), n("div", tn, [
      e("div", sn, [
        ...
        ue.value.length > 0 ? (a(), n("div", {
          ...
          e("ul", {
            ...
            (a(!0), n(H, null, q(ue.value, (x) => (a(), n("li", {
              key: x.message
            }, h(x.message), 1))), 128))
          ], 4)
        ], 4)) : S("", !0),
        Re.value.length > 0 ? (a(), n("div", {
          ...
          e("ul", an, [
            (a(!0), n(H, null, q(Re.value, (x) => (a(), n("li", {
              key: x.message
            }, h(x.message), 1))), 128))
          ])
        ], 4)) : S("", !0)
      ...
      e("div", nn, [
        e("aside", ln, [
          s.disabledSections.includes("message") ? S("", !0) : (a(), n("div", on, [
            !c(R).message.title_template && !c(R).message.body_template ? (a(), n("div", rn, " Add a title and message below to get started. ")) : S("", !0),
            e("div", dn, [
              ...
              e("div", un, [
                ...
                e("select", {
                  ...
                  (a(!0), n(H, null, q(c(nt), (x) => (a(), n("option", {
                    key: x.id,
                    value: x.id
                  }, h(x.label), 9, cn))), 128))
                ], 32)
          ...
          s.disabledSections.includes("delivery") ? S("", !0) : (a(), n("div", pn, [
        ...
        e("main", mn, [
          ...
          e("div", bn, [
            e("div", gn, [
              e("label", yn, [
                ...
                Ie(e("select", {
                  ...
                  (a(!0), n(H, null, q(c(Ve), (x) => (a(), n("option", {
                    key: x.id,
                    value: x.id
                  }, h(x.label), 9, fn))), 128))
                ], 512), [
            ...
            e("div", hn, [
              (a(), n(H, null, q(["android", "ios", "web"], (x) => e("button", {
                key: x,
                type: "button",
                class: de(["kb-push-device-btn", { "kb-push-device-btn--active": o.value === x }]),
                role: "tab",
                "aria-selected": o.value === x,
                "aria-controls": `kb-preview-panel-${x}`,
                onClick: (Z) => o.value = x
              }, h(x.toUpperCase()), 11, kn)), 64))
            ]),
            e("div", _n, [
              !c(R).message.title_template && !c(R).message.body_template ? (a(), n("div", wn, [...g[18] || (g[18] = [
                ...
                "onUpdate:selectedPlatform": g[4] || (g[4] = (x) => o.value = x)
      ...
      e("footer", $n, [
        e("button", {
          ...
          onClick: g[5] || (g[5] = (x) => y.value = !0)
        }, " Version history "),
        e("button", {
          type: "button",
          class: "kb-push-action kb-push-action--secondary",
          onClick: g[6] || (g[6] = (x) => d("save-version", JSON.parse(JSON.stringify(c(R)))))
        }, " Save as version "),
        e("button", {
          type: "button",
          class: "kb-push-action kb-push-action--secondary",
          onClick: g[7] || (g[7] = (x) => d("duplicate", JSON.parse(JSON.stringify(c(R)))))
        }, " Duplicate "),
        e("button", {
          type: "button",
          class: "kb-push-action kb-push-action--secondary",
        ...
        e("div", Cn, [
          ...
          e("div", Sn, [
            ...
            e("button", {
              type: "button",
              class: "kb-push-action kb-push-action--primary",
              onClick: g[10] || (g[10] = (x) => p.value && N(p.value))
            }, "Replace")
          ])
        ])
      ])) : S("", !0),
      re(gt, {
        open: y.value,
        versions: s.versions,
        onClose: g[11] || (g[11] = (x) => y.value = !1),
        onRestore: M
      }, null, 8, ["open", "versions"])
    ]));
  }
}), yt = /* @__PURE__ */ ie(In, [["__scopeId", "data-v-8d48d689"]]), Un = { class: "kb-section" }, Rn = { class: "kb-section__head" }, An = { class: "kb-field" }, Ln = ["value"], Tn = { class: "kb-field" }, Bn = ["value"], Pn = {
  key: 0,
  class: "kb-field"
}, En = ["value"], Vn = {
  key: 1,
  ...
  setup(s, { emit: r }) {
    ...
    function o(v) {
      ...
      let T;
      for (; (T = p.exec(v)) !== null; ) y.add(T[1].trim());
      return Array.from(y);
    }
    const m = I(() => {
      const v = i.message.whatsapp_header ?? "", p = i.message.whatsapp_body ?? i.message.body_template ?? "", y = new Set(i.message.variables_used ?? []), T = [...o(v), ...o(p)];
      return Array.from(new Set(T)).map((N) => ({ name: N, configured: y.has(N) }));
    });
    return (v, p) => {
      var y, T, Y, N;
      return a(), n("section", Un, [
        e("div", Rn, [
          ...
          s.showReset ? (a(), n("button", {
            ...
            type: "button",
            class: "kb-section__reset",
            onClick: p[0] || (p[0] = (w) => v.$emit("reset"))
          }, " Reset section ")) : S("", !0)
        ]),
        ...
        e("div", An, [
          ...
          e("select", {
            ...
            onChange: p[1] || (p[1] = (w) => d("update", {
              whatsapp_template_type: w.target.value
            }))
          }, [...p[19] || (p[19] = [
        ...
        e("div", Tn, [
          ...
          e("input", {
            ...
            onInput: p[2] || (p[2] = (w) => d("update", {
              whatsapp_template_name: w.target.value || void 0
            }))
          }, null, 40, Bn)
        ]),
        ["image", "video", "document"].includes(i.message.whatsapp_template_type ?? "text") ? (a(), n("div", Pn, [
          ...
          e("input", {
            ...
            onInput: p[3] || (p[3] = (w) => d("update", {
              whatsapp_media_url: w.target.value || void 0
            }))
          }, null, 40, En)
        ])) : S("", !0),
        ["image", "video", "document"].includes(i.message.whatsapp_template_type ?? "text") ? (a(), n("div", Vn, [
          ...
          e("input", {
            ...
            onInput: p[4] || (p[4] = (w) => d("update", {
              whatsapp_media_caption: w.target.value || void 0
            }))
          }, null, 40, Mn)
        ])) : S("", !0),
          ...
          e("div", Nn, [
            e("input", {
              ...
              onInput: p[5] || (p[5] = (w) => {
                ...
                M.lat = Number(w.target.value), d("update", { whatsapp_location: M });
              })
            }, null, 40, Dn),
            e("input", {
              type: "number",
              ...
              value: ((T = i.message.whatsapp_location) == null ? void 0 : T.lon) ?? "",
              onInput: p[6] || (p[6] = (w) => {
                const M = { ...i.message.whatsapp_location ?? {} };
                M.lon = Number(w.target.value), d("update", { whatsapp_location: M });
              })
            }, null, 40, zn)
          ]),
          e("input", {
            ...
            onInput: p[7] || (p[7] = (w) => {
              const M = { ...i.message.whatsapp_location ?? {} };
              M.name = w.target.value || void 0, d("update", { whatsapp_location: M });
            })
          }, null, 40, Hn),
          e("input", {
            type: "text",
            ...
            onInput: p[8] || (p[8] = (w) => {
              const M = { ...i.message.whatsapp_location ?? {} };
              M.address = w.target.value || void 0, d("update", { whatsapp_location: M });
            })
          }, null, 40, Wn)
        ])) : S("", !0),
        i.message.whatsapp_template_type === "coupon" ? (a(), n("div", Fn, [
          ...
          e("input", {
            ...
            onInput: p[9] || (p[9] = (w) => d("update", {
              whatsapp_coupon_code: w.target.value || void 0
            }))
          }, null, 40, jn)
        ])) : S("", !0),
        i.message.whatsapp_template_type === "lto" ? (a(), n("div", qn, [
          ...
          e("input", {
            ...
            onInput: p[10] || (p[10] = (w) => d("update", {
              whatsapp_lto_expiry: w.target.value || void 0
            }))
          }, null, 40, Kn)
        ])) : S("", !0),
        ["mpm", "catalog"].includes(i.message.whatsapp_template_type) ? (a(), n("div", Yn, [
          ...
          e("div", Jn, [
            (a(!0), n(H, null, q(i.message.whatsapp_products ?? [], (w, M) => (a(), n("div", {
              key: w.id || M,
        ...
        i.message.whatsapp_template_type === "auth" ? (a(), n("div", Zn, [
          ...
          e("select", {
            ...
            onChange: p[12] || (p[12] = (w) => d("update", {
              whatsapp_auth_type: w.target.value
            }))
          }, [...p[28] || (p[28] = [
          ...
          e("input", {
            ...
            onInput: p[13] || (p[13] = (w) => d("update", {
              whatsapp_auth_label: w.target.value || void 0
            }))
          }, null, 40, tl)
        ])) : S("", !0),
        e("div", sl, [
          ...
          e("input", {
            ...
            onInput: p[14] || (p[14] = (w) => d("update", {
              whatsapp_header: w.target.value || void 0
            }))
          }, null, 40, al)
        ]),
        e("div", nl, [
          ...
          e("textarea", {
            ...
            onInput: p[15] || (p[15] = (w) => d("update", {
              whatsapp_body: w.target.value || void 0
            }))
          }, null, 40, ll)
        ]),
        m.value.length > 0 ? (a(), n("div", ol, [
          ...
          e("ul", il, [
            (a(!0), n(H, null, q(m.value, (w) => (a(), n("li", {
              key: w.name,
              class: de(["kb-wa-field-item", { "kb-wa-field-item--ok": w.configured }])
            }, [
              e("span", rl, h(w.name), 1),
              e("span", dl, h(w.configured ? "Configured" : "Missing"), 1)
            ], 2))), 128))
          ])
        ])) : S("", !0),
        e("div", ul, [
          ...
          e("input", {
            ...
            onInput: p[16] || (p[16] = (w) => d("update", {
              whatsapp_footer: w.target.value || void 0
            }))
          }, null, 40, cl)
        ]),
        e("div", pl, [
          ...
          e("div", ml, [
            (a(!0), n(H, null, q(i.message.whatsapp_buttons ?? [], (w, M) => (a(), n("div", {
              key: w.id || M,
              class: "kb-wa-button-row"
            }, [
              e("input", {
              ...
              }, null, 40, gl)) : w.type === "call" ? (a(), n("input", {
                key: 1,
                type: "tel",
                class: "kb-input kb-input--btn-target",
  ...
  key: 1,
  class: "location-card"
}, Tl = ["src"], Bl = { class: "location-info" }, Pl = {
  key: 2,
  class: "catalog-card"
  ...
  setup(s) {
    const r = s, i = J("light"), d = I(() => i.value === "dark");
    function o(p) {
      return String(p).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
    }
    const m = I(() => {
      var T;
      const p = ((T = r.template) == null ? void 0 : T.body) ?? "";
      return o(p).replace(/\n/g, "<br>").replace(/\*(.*?)\*/g, "<b>$1</b>").replace(/_(.*?)_/g, "<i>$1</i>");
    }), v = I(() => {
      const p = r.template.location;
      if (!p) return "";
      const { lat: y, lng: T } = p;
      return y == null || T == null ? "" : `https://maps.googleapis.com/maps/api/staticmap?center=${y},${T}&zoom=15&size=600x300&markers=${y},${T}`;
    });
    return (p, y) => {
      var T, Y;
      return a(), n("div", {
            ...
            e("div", xl, [
              s.template.header ? (a(), n("div", Cl, [
                s.template.header.type === "text" ? (a(), n("div", Sl, h(s.template.header.text), 1)) : s.template.header.type === "image" ? (a(), n("img", {
                  ...
                  controls: "",
                  class: "media"
                }, null, 8, Ul)) : s.template.header.type === "document" ? (a(), n("div", Rl, " 📄 " + h(s.template.header.filename), 1)) : S("", !0)
              ])) : S("", !0),
              e("div", {
                class: "body",
                innerHTML: m.value
              }, null, 8, Al),
              s.template.location ? (a(), n("div", Ll, [
                v.value ? (a(), n("img", {
                  key: 0,
                  src: v.value,
                  class: "map",
              ...
              s.template.catalog ? (a(), n("div", Pl, [
                e("div", El, [
                  y[2] || (y[2] = Q(" 🛍 ", -1)),
                  e("span", Vl, h(typeof s.template.catalog == "object" && s.template.catalog.label ? s.template.catalog.label : "Full catalog"), 1)
                ]),
                y[3] || (y[3] = e("div", { class: "catalog-sub" }, "Browse all items", -1)),
                y[4] || (y[4] = e("div", { class: "catalog-cta" }, "VIEW CATALOG", -1))
              ])) : S("", !0),
              (T = s.template.multiProduct) != null && T.length ? (a(), n("div", Ml, [
                (a(!0), n(H, null, q(s.template.multiProduct, (N, w) => (a(), n("div", {
                  key: w,
                  class: "product"
                }, [
                  N.image ? (a(), n("img", {
              ...
              s.template.limitedOffer ? (a(), n("div", Fl, " ⏳ Offer expires " + h(s.template.limitedOffer), 1)) : S("", !0),
              s.template.auth ? (a(), n("div", jl, [
                y[8] || (y[8] = e("div", { class: "auth-icon" }, "🔐", -1)),
                y[9] || (y[9] = e("div", { class: "auth-title" }, "Confirm your phone number", -1)),
                e("div", ql, h(s.template.auth.code), 1),
                y[10] || (y[10] = e("button", {
                  type: "button",
                  class: "auth-btn"
                }, "CONTINUE", -1))
              ])) : S("", !0),
              s.template.footer ? (a(), n("div", Kl, h(s.template.footer), 1)) : S("", !0),
              (Y = s.template.buttons) != null && Y.length ? (a(), n("div", Yl, [
                (a(!0), n(H, null, q(s.template.buttons, (N, w) => (a(), n("button", {
                  key: w,
                  type: "button",
                  class: "button"
                }, h(N.text), 1))), 128))
  ...
  setup(s, { emit: r }) {
    ...
    function A(B) {
      (B.metaKey || B.ctrlKey) && B.key === "z" && (B.preventDefault(), B.shiftKey ? Y() : T());
    }
    De(() => {
    ...
    const oe = I(() => v(f.value)), me = I(() => oe.value.blockingErrors), be = I(() => oe.value.warnings), _e = I(() => oe.value.valid), ke = J(""), ve = J(!1), U = J(null), se = I(() => {
      const B = ke.value;
      return B ? Ve.find((O) => O.id === B) ?? null : null;
    }), ne = I(() => {
      const B = o.value.message.whatsapp_body ?? o.value.message.body_template ?? "";
      return se.value ? Pe(B, se.value.data) : B;
    }), C = I(() => {
      const B = o.value.message.whatsapp_header ?? "";
      return se.value ? Pe(B, se.value.data) : B;
    }), fe = I(() => {
      const B = o.value.message, O = B.whatsapp_template_type ?? "text";
      let K, ce, D, z, G, Ce, F;
      O === "image" && B.whatsapp_media_url ? K = { type: "image", url: B.whatsapp_media_url } : O === "video" && B.whatsapp_media_url ? K = { type: "video", url: B.whatsapp_media_url } : O === "document" && B.whatsapp_document_filename ? K = { type: "document", filename: B.whatsapp_document_filename } : B.whatsapp_header && (K = { type: "text", text: C.value });
      const k = ne.value || "Start adding content to see a live preview here.";
      if (O === "location" && B.whatsapp_location) {
        const $ = B.whatsapp_location, _ = $.lat ?? $.latitude, g = $.lng ?? $.lon ?? $.longitude;
        _ != null && g != null && (ce = {
          lat: _,
          lng: g,
          name: $.name ?? $.title,
      ...
      (O === "catalog" || O === "mpm") && Array.isArray(B.whatsapp_products) && B.whatsapp_products.length && (D = !0, z = B.whatsapp_products.map(($) => ({
        image: $.image ?? $.imageUrl,
        name: $.name ?? $.sectionTitle ?? $.title ?? "Product",
        price: $.price ?? $.productId ?? ""
      }))), O === "coupon" && B.whatsapp_coupon_code && (G = { code: B.whatsapp_coupon_code }), O === "lto" && B.whatsapp_lto_expiry && (Ce = B.whatsapp_lto_expiry), O === "auth" && (F = { code: B.whatsapp_auth_code ?? B.whatsapp_otp_code ?? "123 456" });
      const P = B.whatsapp_buttons ?? [];
      return {
        header: K,
        body: k,
        footer: B.whatsapp_footer || void 0,
        buttons: P.map(($) => ({ text: $.label || "Button" })),
        location: ce,
        catalog: D,
        multiProduct: z,
        coupon: G,
    ...
    function we(B) {
      const O = o.value, K = B.campaign.message ? { ...O.message, ...B.campaign.message } : O.message;
      p({
        ...B.campaign,
        message: K
    ...
    function Ae(B) {
      ...
      K && (m.value ? (U.value = K, ve.value = !0) : we(K), B.target.value = "");
    }
    ...
    function ge(B) {
      p({
        name: B,
        tracking: { ...o.value.tracking ?? {}, campaign_name: B }
      });
    }
    function ue(B) {
      const O = ` {{ ${B.variable} }}`, K = o.value.message.variables_used ?? [], ce = Array.from(/* @__PURE__ */ new Set([...K, B.variable]));
      if (B.field === "title") {
    ...
    return (B, O) => (a(), n("div", Ql, [
      e("div", Xl, [
        ...
        me.value.length > 0 ? (a(), n("div", {
          ...
          e("ul", {
            ...
            (a(!0), n(H, null, q(me.value, (K) => (a(), n("li", {
              key: K.message
            }, h(K.message), 1))), 128))
          ], 4)
        ], 4)) : S("", !0),
        be.value.length > 0 ? (a(), n("div", {
          ...
          e("ul", Zl, [
            (a(!0), n(H, null, q(be.value, (K) => (a(), n("li", {
              key: K.message
            }, h(K.message), 1))), 128))
          ])
        ], 4)) : S("", !0)
      ...
      e("div", eo, [
        e("aside", to, [
          s.disabledSections.includes("whatsapp") ? S("", !0) : (a(), n("div", so, [
            e("div", ao, [
              ...
              e("div", no, [
                ...
                e("select", {
                  ...
                  (a(!0), n(H, null, q(c(lt), (K) => (a(), n("option", {
                    key: K.id,
                    value: K.id
                  }, h(K.label), 9, lo))), 128))
                ], 32)
            ...
            e("div", uo, [
              e("label", co, [
                ...
                Ie(e("select", {
                  ...
                  (a(!0), n(H, null, q(c(Ve), (K) => (a(), n("option", {
                    key: K.id,
                    value: K.id
                  }, h(K.label), 9, po))), 128))
                ], 512), [
...
}), ft = /* @__PURE__ */ ie(fo, [["__scopeId", "data-v-d41b0788"]]), ho = { class: "kb-section" }, ko = { class: "kb-section__head" }, _o = { class: "kb-field" }, wo = ["value"], $o = { class: "kb-field" }, xo = { class: "kb-label" }, Co = { key: 0 }, So = { key: 1 }, Io = { key: 2 }, Uo = ["value"], Ro = {
  key: 0,
  class: "kb-truncation-hint"
}, Ao = { class: "kb-field" }, Lo = { class: "kb-insert-row" }, To = ["value"], Bo = { class: "kb-field" }, Po = { class: "kb-insert-row" }, Eo = /* @__PURE__ */ le({
  __name: "SectionSms",
  props: {
    message: {},
    variableOptions: {},
  ...
  emits: ["update", "reset"],
  setup(s, { emit: r }) {
    const i = s, d = r, o = ["first_name", "last_name", "order_id", "city"], m = J(i.variableOptions && i.variableOptions.length ? [...i.variableOptions] : o), v = J(m.value[0] ?? o[0]), p = J("");
    ye(
      () => i.variableOptions,
      (A) => {
    ...
    const y = I(() => i.message.sms_body ?? ""), T = I(() => y.value.length), Y = I(() => T.value ? T.value <= 160 ? 1 : Math.ceil(T.value / 153) : 0), N = I(() => {
      const A = T.value;
    ...
    return (A, f) => (a(), n("section", ho, [
      ...
      e("div", $o, [
        ...
        N.value ? (a(), n("p", Ro, h(N.value), 1)) : S("", !0)
      ]),
      e("div", Ao, [
        ...
        e("div", Lo, [
          Ie(e("select", {
            ...
            (a(!0), n(H, null, q(m.value, (ee) => (a(), n("option", {
              key: ee,
              value: ee
            }, h(ee), 9, To))), 128))
          ], 512), [
  ...
  setup(s, { emit: r }) {
    ...
    function A(D) {
      (D.metaKey || D.ctrlKey) && D.key === "z" && (D.preventDefault(), D.shiftKey ? Y() : T());
    }
    De(() => {
      window.addEventListener("keydown", A);
    }), ze(() => {
    ...
    pe(), ye(() => o.value.audience, pe, { deep: !0 });
    const oe = I(() => v(f.value)), me = I(() => oe.value.blockingErrors), be = I(() => oe.value.warnings), _e = I(() => oe.value.valid), ke = I(() => o.value.template_type ?? "transactional"), ve = J(""), U = J(!1), se = J(null), ne = I(() => {
      const D = ve.value;
    ...
    return (D, z) => (a(), n("div", Mo, [
      e("div", Oo, [
        ...
        me.value.length > 0 ? (a(), n("div", {
          ...
          e("ul", {
            ...
            (a(!0), n(H, null, q(me.value, (G) => (a(), n("li", {
              key: G.message
            }, h(G.message), 1))), 128))
          ], 4)
        ], 4)) : S("", !0),
        be.value.length > 0 ? (a(), n("div", {
          ...
          e("ul", No, [
            (a(!0), n(H, null, q(be.value, (G) => (a(), n("li", {
              key: G.message
            }, h(G.message), 1))), 128))
          ])
        ], 4)) : S("", !0)
      ...
      e("div", Do, [
        e("aside", zo, [
          s.disabledSections.includes("sms") ? S("", !0) : (a(), n("div", Ho, [
            e("div", Wo, [
              ...
              e("div", Fo, [
                ...
                e("select", {
                  ...
                  (a(!0), n(H, null, q(c(ot), (G) => (a(), n("option", {
                    key: G.id,
                    value: G.id
                  }, h(G.label), 9, jo))), 128))
                ], 32)
        ...
        e("main", qo, [
          c(o).audience.test_mode ? (a(), n("div", Ko, [...z[8] || (z[8] = [
            ...
            e("div", Jo, [
              e("label", Go, [
                ...
                Ie(e("select", {
                  ...
                  (a(!0), n(H, null, q(c(Ve), (G) => (a(), n("option", {
                    key: G.id,
                    value: G.id
                  }, h(G.label), 9, Qo))), 128))
                ], 512), [
              ...
              e("div", Zo, [
                e("div", ei, [
                  ...
                  e("p", ii, [
                    ...
                    ue.value === 0 ? (a(), n("span", ri, "0 segments")) : ue.value === 1 ? (a(), n("span", di, "1 segment")) : (a(), n("span", ui, h(ue.value) + " segments", 1)),
                    z[14] || (z[14] = Q(" (160 chars for 1 segment, 153 for multi-part) ", -1)),
                    B.value !== null ? (a(), n("span", ci, " · Est. " + h(B.value), 1)) : S("", !0)
                  ]),
                  O.value ? (a(), n("p", pi, h(O.value), 1)) : S("", !0)
                ])
              ])
            ])
          ])
...
}), ht = /* @__PURE__ */ ie(yi, [["__scopeId", "data-v-3a8268b7"]]), fi = 30, hi = 60, ki = 130;
function _i(s) {
...
const Si = { class: "em-section" }, Ii = { class: "em-strip" }, Ui = { class: "em-strip-head" }, Ri = { class: "em-field" }, Ai = ["value"], Li = { class: "em-field" }, Ti = ["value"], Bi = { class: "em-field" }, Pi = ["value"], Ei = { class: "em-field" }, Vi = { class: "em-input-group" }, Mi = ["value"], Oi = {
  key: 0,
  ...
  key: 6,
  class: "em-block-fields"
}, Rr = ["value", "onChange"], Ar = { class: "em-list-items" }, Lr = ["value", "onInput", "placeholder"], Tr = ["onClick"], Br = ["onClick"], Pr = {
  key: 7,
  class: "em-block-fields"
  ...
  key: 16,
  class: "em-block-fields"
}, Ad = ["value", "onInput"], Ld = ["value", "onInput"], Td = ["value", "onInput"], Bd = ["onClick"], Pd = ["onClick"], Ed = {
  key: 17,
  class: "em-block-fields"
...
const example = {{ order_id }};`,
    ...
    const m = s, v = r, p = ["first_name", "last_name", "order_id", "city", "email"], y = J(
      (Te = m.variableOptions) != null && Te.length ? [...m.variableOptions] : p
    ), T = J(y.value[0] ?? "first_name"), Y = J("");
    ye(
      () => m.variableOptions,
      (b) => {
        b != null && b.length && (y.value = [...b], y.value.includes(T.value) || (T.value = y.value[0]));
      }
    );
    const N = I(() => m.message.email_subject ?? ""), w = I(() => m.message.email_preview_text ?? ""), M = I(() => _i(N.value)), R = I(() => wi(w.value)), W = I(() => rt(N.value)), A = I(() => rt(w.value)), f = I(() => {
    ...
    function we(b) {
      ...
      !l || l.type !== "list" || C(b, { items: [...l.items || [], "New item"] });
    }
    function Ae(b, l) {
    ...
    function Ue(b, l, t, V) {
      const u = f.value.find((L) => L.id === b);
      if (!u || u.type !== "social") return;
      const E = (u.links || []).map((L, he) => he === l ? { ...L, [t]: V } : L);
      C(b, { links: E });
    }
    function xe(b) {
      const l = f.value.find((t) => t.id === b);
      !l || l.type !== "social" || C(b, { links: [...l.links || [], { platform: "custom", url: "" }] });
    }
    function ge(b, l) {
      const t = f.value.find((u) => u.id === b);
    ...
    function Re(b) {
      const l = f.value.find((t) => t.id === b);
      !l || l.type !== "link_list" || C(b, { links: [...l.links || [], { text: "", url: "" }] });
    }
    function B(b, l) {
      const t = f.value.find((u) => u.id === b);
    ...
    function O(b, l) {
      ...
      const V = ` {{ ${T.value} }}`, u = m.message.variables_used ?? [], E = Array.from(/* @__PURE__ */ new Set([...u, T.value])), L = l === "left" ? "leftContent" : "rightContent", Ye = (t[L] ?? "") + V;
      C(b, { [L]: Ye }), v("update", { variables_used: E });
    }
    function K(b, l) {
    ...
    function z(b) {
      const l = f.value.find((t) => t.id === b);
      !l || l.type !== "navbar" || C(b, { links: [...l.links || [], { text: "", url: "" }] });
    }
    function G(b, l) {
      const t = f.value.find((V) => V.id === b);
      !t || t.type !== "navbar" || C(b, { links: (t.links || []).filter((V, u) => u !== l) });
    }
    function Ce(b, l, t, V) {
      const u = f.value.find((L) => L.id === b);
      if (!u || u.type !== "accordion") return;
      const E = (u.items || []).map((L, he) => he === l ? { ...L, [t]: V } : L);
      C(b, { items: E });
    }
    function F(b) {
      const l = f.value.find((t) => t.id === b);
      !l || l.type !== "accordion" || C(b, { items: [...l.items || [], { title: "New section", content: "" }] });
    }
    function k(b, l) {
      const t = f.value.find((V) => V.id === b);
      !t || t.type !== "accordion" || C(b, { items: (t.items || []).filter((V, u) => u !== l) });
    }
    function P(b, l, t, V) {
      const u = f.value.find((L) => L.id === b);
      if (!u || u.type !== "carousel") return;
      const E = (u.slides || []).map((L, he) => he === l ? { ...L, [t]: V } : L);
      C(b, { slides: E });
    }
    function $(b) {
      const l = f.value.find((t) => t.id === b);
      !l || l.type !== "carousel" || C(b, { slides: [...l.slides || [], { imageUrl: "", linkUrl: "", alt: "" }] });
    }
    function _(b, l) {
      const t = f.value.find((V) => V.id === b);
      !t || t.type !== "carousel" || C(b, { slides: (t.slides || []).filter((V, u) => u !== l) });
    }
    function g(b) {
      const l = ` {{ ${T.value} }}`, t = m.message.variables_used ?? [], V = Array.from(/* @__PURE__ */ new Set([...t, T.value]));
      b === "subject" ? v("update", {
        email_subject: (N.value || "") + l,
        variables_used: V
      }) : v("update", {
        email_preview_text: (w.value || "") + l,
        variables_used: V
      });
    }
    function x(b) {
      ...
      const t = ` {{ ${T.value} }}`, V = m.message.variables_used ?? [], u = Array.from(/* @__PURE__ */ new Set([...V, T.value])), E = (l.type === "footer", "content"), he = (l[E] ?? "") + t, Ye = f.value.map(
    ...
    function Z(b, l) {
      ...
      const V = ` {{ ${T.value} }}`, u = m.message.variables_used ?? [], E = Array.from(/* @__PURE__ */ new Set([...u, T.value])), L = [...t.cells || []];
      L[l] = (L[l] || "") + V, C(b, { cells: L }), v("update", { variables_used: E });
    }
    function ae() {
      const b = Y.value.trim();
      !b || y.value.includes(b) || (y.value = [...y.value, b], T.value = b, Y.value = "");
    }
    return (b, l) => (a(), n("section", Si, [
      e("div", Ii, [
        ...
        e("div", Ei, [
          ...
          W.value.length ? (a(), n("span", Oi, "Spammy: " + h(W.value.join(", ")), 1)) : S("", !0)
        ]),
        e("div", Ni, [
          ...
          A.value.length ? (a(), n("span", Hi, "Spammy: " + h(A.value.join(", ")), 1)) : S("", !0)
        ])
      ]),
      e("div", Wi, [
      ...
      e("div", qi, [
        ...
        e("div", Ki, [
          (a(!0), n(H, null, q(f.value, (t, V) => (a(), n("div", {
            key: t.id,
            class: "em-block",
            "data-type": t.type
          }, [
            ...
            t.type === "heading" ? (a(), n("div", tr, [
              e("select", {
                ...
                onChange: (u) => C(t.id, { level: Number(u.target.value) })
              }, [...l[38] || (l[38] = [
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.content,
                onInput: (u) => C(t.id, { content: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.src,
                onInput: (u) => C(t.id, { src: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.alt,
                onInput: (u) => C(t.id, { alt: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.linkUrl,
                onInput: (u) => C(t.id, { linkUrl: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.text,
                onInput: (u) => C(t.id, { text: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.url,
                onInput: (u) => C(t.id, { url: u.target.value }),
              ...
              e("div", br, [
                ...
                e("input", {
                  ...
                  onInput: (u) => C(t.id, { borderRadius: Number(u.target.value) || 0 })
                }, null, 40, gr)
              ]),
              e("label", yr, [
                e("input", {
                  type: "checkbox",
                  checked: t.fullWidth,
                  onChange: (u) => C(t.id, { fullWidth: u.target.checked })
                }, null, 40, fr),
              ...
              e("label", hr, [
                e("input", {
                  type: "checkbox",
                  checked: t.ghost,
                  onChange: (u) => C(t.id, { ghost: u.target.checked })
                }, null, 40, kr),
              ...
              e("input", {
                ...
                max: "120",
                value: t.height,
                onInput: (u) => C(t.id, { height: Number(u.target.value) || 24 })
              }, null, 40, wr),
              ...
              e("input", {
                ...
                onInput: (u) => C(t.id, { unsubscribeUrl: u.target.value }),
              ...
              e("input", {
                ...
                onInput: (u) => C(t.id, { companyAddress: u.target.value }),
              ...
              e("div", Ar, [
                (a(!0), n(H, null, q(t.items || [], (u, E) => (a(), n("div", {
                  ...
                  e("input", {
                    ...
                    class: "em-input em-input--flex",
                    value: u,
                    onInput: (L) => fe(t.id, E, L.target.value),
              ...
              e("div", Nr, [
                (a(!0), n(H, null, q(t.links || [], (u, E) => (a(), n("div", {
                  key: E,
                  class: "em-social-row"
                }, [
                  e("select", {
                    value: u.platform,
                    class: "em-select em-select--sm",
                    onChange: (L) => Ue(t.id, E, "platform", L.target.value)
                  }, [...l[46] || (l[46] = [
                  ...
                  e("input", {
                    ...
                    class: "em-input em-input--flex",
                    value: u.url,
                    onInput: (L) => Ue(t.id, E, "url", L.target.value),
              ...
              e("input", {
                ...
                onInput: (u) => C(t.id, { thumbnailUrl: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.videoUrl,
                onInput: (u) => C(t.id, { videoUrl: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.caption,
                onInput: (u) => C(t.id, { caption: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input em-input--narrow",
                value: t.separator,
                onInput: (u) => C(t.id, { separator: u.target.value || " | " }),
              ...
              e("div", Gr, [
                (a(!0), n(H, null, q(t.links || [], (u, E) => (a(), n("div", {
                  ...
                  e("input", {
                    ...
                    class: "em-input em-input--flex",
                    value: u.text,
                    onInput: (L) => ue(t.id, E, "text", L.target.value),
                    placeholder: "Label"
                  }, null, 40, Qr),
                  e("input", {
                    type: "url",
              ...
              e("textarea", {
                class: "em-textarea em-textarea--sm",
                value: t.leftContent,
                onInput: (u) => C(t.id, { leftContent: u.target.value }),
              ...
              e("textarea", {
                ...
                onInput: (u) => C(t.id, { rightContent: u.target.value }),
              ...
              e("div", id, [
                ...
                e("input", {
                  ...
                  max: "8",
                  value: t.thickness ?? 1,
                  onInput: (u) => C(t.id, { thickness: Number(u.target.value) || 1 })
                }, null, 40, rd),
              ...
              e("div", dd, [
                ...
                e("input", {
                  ...
                  onInput: (u) => C(t.id, { color: u.target.value || "#e2e8f0" }),
                  placeholder: "#e2e8f0"
                }, null, 40, ud)
              ]),
              e("select", {
                ...
                class: "em-select em-select--sm",
                onChange: (u) => C(t.id, { lineStyle: u.target.value })
              }, [...l[52] || (l[52] = [
              ...
              (a(!0), n(H, null, q(t.cells || [], (u, E) => (a(), n("div", {
                key: E,
                class: "em-row-cell"
              }, [
                ...
                e("textarea", {
                  class: "em-textarea em-textarea--sm",
                  value: u,
                  onInput: (L) => ce(t.id, E, L.target.value),
              ...
              e("div", hd, [
                (a(!0), n(H, null, q(t.links || [], (u, E) => (a(), n("div", {
                  ...
                  e("input", {
                    ...
                    class: "em-input em-input--flex",
                    value: u.text,
                    onInput: (L) => D(t.id, E, "text", L.target.value),
                    placeholder: "Label"
                  }, null, 40, kd),
                  e("input", {
                    type: "url",
                    class: "em-input em-input--flex",
                    value: u.url,
                    onInput: (L) => D(t.id, E, "url", L.target.value),
                    placeholder: "URL"
                  }, null, 40, _d),
                  e("button", {
                    type: "button",
              ...
              (a(!0), n(H, null, q(t.items || [], (u, E) => (a(), n("div", {
                ...
                e("input", {
                  ...
                  class: "em-input",
                  value: u.title,
                  onInput: (L) => Ce(t.id, E, "title", L.target.value),
                  placeholder: "Section title"
                }, null, 40, Cd),
                e("textarea", {
                  class: "em-textarea em-textarea--sm",
                  value: u.content,
                  onInput: (L) => Ce(t.id, E, "content", L.target.value),
              ...
              (a(!0), n(H, null, q(t.slides || [], (u, E) => (a(), n("div", {
                key: E,
                ...
                e("input", {
                  ...
                  class: "em-input",
                  value: u.imageUrl,
                  onInput: (L) => P(t.id, E, "imageUrl", L.target.value),
                  placeholder: "Image URL"
                }, null, 40, Ad),
                e("input", {
                  type: "text",
                  class: "em-input",
                  value: u.alt,
                  onInput: (L) => P(t.id, E, "alt", L.target.value),
                  placeholder: "Alt text"
                }, null, 40, Ld),
                e("input", {
                  type: "url",
                  class: "em-input",
                  value: u.linkUrl,
                  onInput: (L) => P(t.id, E, "linkUrl", L.target.value),
                  placeholder: "Link URL (optional)"
                }, null, 40, Td),
                e("button", {
                  type: "button",
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.label,
                onInput: (u) => C(t.id, { label: u.target.value }),
              ...
              e("input", {
                ...
                onInput: (u) => C(t.id, { endDateTime: u.target.value ? new Date(u.target.value).toISOString() : "" }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.imageUrl,
                onInput: (u) => C(t.id, { imageUrl: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.title,
                onInput: (u) => C(t.id, { title: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.price,
                onInput: (u) => C(t.id, { price: u.target.value }),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.buttonText,
                onInput: (u) => C(t.id, { buttonText: u.target.value }),
                placeholder: "Button text"
              }, null, 40, Hd),
              e("input", {
                type: "url",
                class: "em-input",
                value: t.buttonUrl,
                onInput: (u) => C(t.id, { buttonUrl: u.target.value }),
                placeholder: "Button URL"
              }, null, 40, Wd)
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.feedUrl,
                onInput: (u) => C(t.id, { feedUrl: u.target.value }),
              ...
              e("div", Zd, [
                ...
                e("input", {
                  ...
                  max: "20",
                  value: t.maxItems ?? 5,
                  onInput: (u) => C(t.id, { maxItems: Number(u.target.value) || 5 })
                }, null, 40, eu)
              ]),
              ...
              e("input", {
                ...
                class: "em-input",
                value: t.fallbackUrl,
                onInput: (u) => C(t.id, { fallbackUrl: u.target.value }),
      ...
      e("div", iu, [
        ...
        e("div", ru, [
          ...
          e("div", du, [
            Ie(e("select", {
              "onUpdate:modelValue": l[26] || (l[26] = (t) => T.value = t),
              class: "em-select em-select--flex"
            }, [
              (a(!0), n(H, null, q(y.value, (t) => (a(), n("option", {
                key: t,
                value: t
              }, h(t), 9, uu))), 128))
            ], 512), [
  ...
  role: "tablist",
  "aria-label": "Viewport"
}, Lu = { class: "kb-email-inbox-strip" }, Tu = { class: "kb-email-inbox-from" }, Bu = { class: "kb-email-inbox-from-name" }, Pu = { class: "kb-email-inbox-from-addr" }, Eu = { class: "kb-email-inbox-subject" }, Vu = ["title"], Mu = {
  key: 0,
  ...
  setup(s, { emit: r }) {
    function i(F) {
      ...
      const k = ($) => String($).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;"), P = [];
      for (const $ of F)
        switch ($.type) {
          case "heading": {
            const _ = Math.min(3, Math.max(1, Number($.level) || 1)), g = k($.content || "").replace(/\s*\{\{\s*([^}]+)\s*\}\}\s*/g, '<span style="color:#2563eb;">{{ $1 }}</span>');
          ...
          case "paragraph": {
            const _ = k($.content || "").replace(/\n/g, "<br/>").replace(/\s*\{\{\s*([^}]+)\s*\}\}\s*/g, '<span style="color:#2563eb;">{{ $1 }}</span>');
            P.push(`<p style="margin:0 0 12px;font-size:14px;line-height:1.5;color:#334155;">${_ || "Paragraph"}</p>`);
            break;
          }
          case "image": {
            const _ = ($.src || "").trim(), g = k($.alt || ""), x = ($.linkUrl || "").trim(), Z = _ ? `<img src="${k(_)}" alt="${g}" style="max-width:100%;height:auto;display:block;border:0;" />` : '<div style="background:#f1f5f9;color:#64748b;padding:40px 16px;text-align:center;font-size:13px;">Image URL</div>';
            P.push(
              `<div style="margin:0 0 12px;">${x ? `<a href="${k(x)}" style="color:#2563eb;">${Z}</a>` : Z}</div>`
            );
            break;
          }
          case "button": {
            const _ = k($.text || "Button"), g = ($.url || "#").trim(), x = Math.min(24, Math.max(0, Number($.borderRadius) ?? 8)), Z = !!$.fullWidth, ae = !!$.ghost, Te = ae ? "transparent" : "#0f172a", b = ae ? "#0f172a" : "#fff", l = ae ? "2px solid #0f172a" : "none", t = Z ? "block" : "inline-block", V = Z ? "100%" : "auto";
            P.push(
              `<p style="margin:0 0 12px;"><a href="${k(g)}" style="display:${t};width:${V};text-align:center;padding:12px 24px;background:${Te};color:${b};border:${l};text-decoration:none;font-size:14px;font-weight:600;border-radius:${x}px;">${_}</a></p>`
            );
            break;
          }
          case "divider": {
            const _ = Math.min(8, Math.max(1, Number($.thickness) || 1)), g = ($.color || "#e2e8f0").trim() || "#e2e8f0", x = $.lineStyle || "solid";
            P.push(
              `<hr style="margin:16px 0;border:0;border-top:${_}px ${x} ${g};" />`
            );
            break;
          }
          case "spacer": {
            const _ = Math.min(120, Math.max(8, Number($.height) || 24));
            P.push(`<div style="height:${_}px;"></div>`);
            break;
          }
          case "footer": {
            const _ = k($.content || "").replace(/\n/g, "<br/>").replace(/\s*\{\{\s*([^}]+)\s*\}\}\s*/g, '<span style="color:#2563eb;">{{ $1 }}</span>'), g = ($.unsubscribeUrl || "").trim(), x = k($.companyAddress || "");
            P.push(
              `<div style="margin:16px 0 0;padding-top:12px;border-top:1px solid #e2e8f0;font-size:12px;color:#64748b;line-height:1.5;">${_ || "Footer"}` + (g ? `<p style="margin:8px 0 0;"><a href="${k(g)}" style="color:#2563eb;">Unsubscribe</a></p>` : "") + (x ? `<p style="margin:4px 0 0;">${x}</p>` : "") + "</div>"
            );
            break;
          }
          case "list": {
            const _ = $.style === "numbered" ? "ol" : "ul", x = (Array.isArray($.items) ? $.items : []).map(
            ...
            P.push(`<${_} style="margin:0 0 12px;padding-left:24px;">${x || "<li>Item</li>"}</${_}>`);
            break;
          }
          case "quote": {
            ...
            }, x = g[$.style || "default"] || g.default;
            P.push(
              `<div style="margin:0 0 12px;padding:16px 20px;border-radius:8px;${x}font-size:14px;line-height:1.6;">${_ || "Quote"}</div>`
            );
            break;
          }
          case "social": {
            const g = (Array.isArray($.links) ? $.links : []).filter((x) => (x.url || "").trim());
            if (g.length === 0)
              P.push(
                '<p style="margin:0 0 12px;font-size:13px;color:#94a3b8;">Add social profile URLs in the sidebar.</p>'
              );
            else {
              const x = (Z) => `<a href="${k((Z.url || "").trim())}" style="display:inline-block;margin:0 8px;color:#2563eb;text-decoration:none;font-size:13px;font-weight:500;">${k(Z.platform || "Link")}</a>`;
              P.push(`<div style="margin:0 0 12px;text-align:center;">${g.map(x).join("")}</div>`);
            }
            break;
          }
          case "video": {
            const _ = ($.thumbnailUrl || "").trim(), g = ($.videoUrl || "#").trim(), x = k($.caption || ""), Z = _ ? `<img src="${k(_)}" alt="Video" style="max-width:100%;height:auto;display:block;border:0;border-radius:8px;" />` : '<div style="background:#e2e8f0;color:#64748b;padding:48px 16px;text-align:center;font-size:14px;border-radius:8px;">Video thumbnail URL</div>';
            P.push(
              `<div style="margin:0 0 12px;"><a href="${k(g)}" style="display:block;color:inherit;">${Z}</a>` + (x ? `<p style="margin:8px 0 0;font-size:12px;color:#64748b;">${x}</p>` : "") + "</div>"
            );
            break;
          }
          case "link_list": {
            const _ = Array.isArray($.links) ? $.links : [], g = k($.separator || " | "), Z = _.filter((ae) => (ae.text || ae.url) && (ae.url || "").trim()).map(
          ...
          case "columns": {
            const _ = k($.leftContent || "").replace(/\n/g, "<br/>").replace(/\s*\{\{\s*([^}]+)\s*\}\}\s*/g, '<span style="color:#2563eb;">{{ $1 }}</span>'), g = k($.rightContent || "").replace(/\n/g, "<br/>").replace(/\s*\{\{\s*([^}]+)\s*\}\}\s*/g, '<span style="color:#2563eb;">{{ $1 }}</span>');
            P.push(
          ...
          case "row": {
            const _ = Math.min(4, Math.max(1, Number($.columnCount) || 2)), g = Array.isArray($.cells) ? $.cells.slice(0, _) : [], x = 100 / _, Z = Array.from({ length: _ }, (ae, Te) => {
              const b = g[Te] ?? "", l = k(b).replace(/\n/g, "<br/>").replace(/\s*\{\{\s*([^}]+)\s*\}\}\s*/g, '<span style="color:#2563eb;">{{ $1 }}</span>');
              return `<td width="${x}%" style="padding:0 8px;font-size:14px;line-height:1.5;color:#334155;vertical-align:top;">${l || "—"}</td>`;
            }).join("");
            P.push(
          ...
          case "accordion": {
            const g = (Array.isArray($.items) ? $.items : []).map((x) => {
              const Z = k(x.title || "Section"), ae = k(x.content || "").replace(/\n/g, "<br/>").replace(/\s*\{\{\s*([^}]+)\s*\}\}\s*/g, '<span style="color:#2563eb;">{{ $1 }}</span>');
          ...
          case "carousel": {
            const g = (Array.isArray($.slides) ? $.slides : []).filter((x) => (x.imageUrl || "").trim());
            if (g.length === 0)
              ...
              const x = g[0], Z = `<img src="${k(x.imageUrl)}" alt="${k(x.alt || "Slide")}" style="max-width:100%;height:auto;display:block;border:0;border-radius:8px;" />`, ae = (x.linkUrl || "").trim();
              P.push(
          ...
          case "countdown": {
            const _ = k($.label || "Offer ends in"), g = $.endDateTime ? new Date($.endDateTime).toLocaleString() : "—";
            P.push(
          ...
          case "product_card": {
            const _ = ($.imageUrl || "").trim(), g = k($.title || "Product"), x = k($.price || ""), Z = k($.buttonText || "Buy now"), ae = ($.buttonUrl || "#").trim(), Te = _ ? `<img src="${k(_)}" alt="${k($.alt || g)}" style="width:100%;height:auto;display:block;border:0;border-radius:8px;" />` : '<div style="background:#f1f5f9;color:#64748b;padding:60px 16px;text-align:center;font-size:13px;">Product image</div>';
            P.push(
              `<div style="margin:0 0 12px;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;"><div style="margin:0 0 12px;">${Te}</div><div style="padding:0 12px 12px;"><p style="margin:0 0 4px;font-size:16px;font-weight:600;color:#0f172a;">${g}</p>` + (x ? `<p style="margin:0 0 12px;font-size:14px;color:#334155;">${x}</p>` : "") + `<a href="${k(ae)}" style="display:inline-block;padding:10px 20px;background:#0f172a;color:#fff;text-decoration:none;font-size:14px;font-weight:600;border-radius:8px;">${Z}</a></div></div>`
            );
            break;
          }
          case "liquid": {
            const _ = k(($.content || "").trim());
            P.push(
          ...
          case "code_block": {
            const _ = ($.content || "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/\n/g, "<br/>").replace(/\s*\{\{\s*([^}]+)\s*\}\}\s*/g, '<span style="color:#2563eb;">{{ $1 }}</span>'), g = k(($.caption || "").trim());
            P.push(
          ...
          case "rss_feed": {
            const _ = ($.feedUrl || "").trim(), g = Math.min(20, Math.max(1, Number($.maxItems) ?? 5));
            P.push(
          ...
          case "dynamic_image": {
            const _ = ($.imageUrl || "").trim(), g = ($.fallbackUrl || "").trim(), x = k($.alt || "Dynamic image");
            _ ? P.push(
              `<div style="margin:0 0 12px;"><img src="${k(_)}" alt="${x}" style="max-width:100%;height:auto;display:block;border:0;" />` + (g ? `<p style="margin:4px 0 0;font-size:11px;color:#94a3b8;">Fallback: ${k(g)}</p>` : "") + "</div>"
            ) : P.push(
    ...
    const me = I(() => p(ee.value)), be = I(() => me.value.blockingErrors), _e = I(() => me.value.warnings), ke = I(() => me.value.valid), ve = I(() => m.value.template_type ?? "transactional"), U = J(""), se = J(!1), ne = J(null), C = I(() => {
      const F = U.value;
    ...
    const xe = I(
      ...
      const F = xe.value;
      return C.value ? Pe(F, C.value.data) : F;
    }), D = I(() => {
      const F = ge.value;
      return C.value ? Pe(F, C.value.data) : F;
    }), z = I(() => {
    ...
    return (F, k) => (a(), n("div", bu, [
      e("div", gu, [
        ...
        be.value.length > 0 ? (a(), n("div", {
          ...
          e("ul", {
            ...
            (a(!0), n(H, null, q(be.value, (P) => (a(), n("li", {
              key: P.message
            }, h(P.message), 1))), 128))
          ], 4)
        ], 4)) : S("", !0),
        _e.value.length > 0 ? (a(), n("div", {
          ...
          e("ul", yu, [
            (a(!0), n(H, null, q(_e.value, (P) => (a(), n("li", {
              key: P.message
            }, h(P.message), 1))), 128))
          ])
        ], 4)) : S("", !0)
      ...
      e("div", fu, [
        e("aside", hu, [
          s.disabledSections.includes("email") ? S("", !0) : (a(), n("div", ku, [
            e("div", _u, [
              ...
              e("div", wu, [
                ...
                e("select", {
                  ...
                  (a(!0), n(H, null, q(c(it), (P) => (a(), n("option", {
                    key: P.id,
                    value: P.id
                  }, h(P.label), 9, $u))), 128))
                ], 32)
        ...
        e("main", xu, [
          ...
          e("div", Su, [
            e("div", Iu, [
              e("label", Uu, [
                ...
                Ie(e("select", {
                  ...
                  (a(!0), n(H, null, q(c(Ve), (P) => (a(), n("option", {
                    key: P.id,
                    value: P.id
                  }, h(P.label), 9, Ru))), 128))
                ], 512), [
            ...
            e("div", {
              ...
              e("div", Lu, [
                e("div", Tu, [
                  e("span", Bu, h(Re.value), 1),
                  e("span", Pu, "<" + h(B.value) + ">", 1)
                ]),
                e("div", Eu, [
                  e("span", {
                  ...
                  D.value ? (a(), n("span", Mu, " — " + h(D.value), 1)) : S("", !0)
                ])
              ]),
              e("div", Ou, [
                e("div", {
...
}), kt = /* @__PURE__ */ ie(Fu, [["__scopeId", "data-v-f38449b2"]]), ju = { class: "kb-shell" }, qu = {
  class: "kb-shell__nav",
  role: "tablist",
  "aria-label": "Channel"
  ...
  setup(s) {
    var m;
    const r = s, i = J(((m = r.items[0]) == null ? void 0 : m.id) ?? "");
    let d = null;
    function o(v) {
    ...
    return De(() => {
      ...
      v && (d = new IntersectionObserver(
        (p) => {
          for (const y of p)
            if (y.isIntersecting) {
              const T = y.target.getAttribute("data-outline-id");
              T && (i.value = T);
            }
        },
      ...
      e("ul", ec, [
        (a(!0), n(H, null, q(s.items, (y) => (a(), n("li", {
          key: y.id,
