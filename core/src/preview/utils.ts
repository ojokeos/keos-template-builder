 ...
 */
export function truncateWithEllipsis(str: string, maxLen: number): { text: string; truncated: boolean } {
 ...
 */
export function wrapLines(str: string, maxChars: number): string[] {
  const lines: string[] = [];
  let remaining = str;
